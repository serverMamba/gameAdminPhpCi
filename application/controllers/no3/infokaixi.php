...
class Infokaixi extends MY_Controller {
	public function __construct() {
       ...
       public function get_kaixi_data() {
       $this->load->model('kaixi_model');
       ...
       */
       ...
       $res = $this->kaixi_model->get_kaixi_his($userid,$eventid,$mystarttime,$myendtime,$account,$beginindex);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"开洗分记录"),
               "header1" => array("father"=>"客服管理","child"=>"开洗分记录"),
               "header2" => array("father"=>"开洗分记录","child"=>"记录玩家的输赢和赠送等情况"),
               "header3" => array("father"=>"开洗分记录后台创建于2014年6月11日","child"=>" 游戏运营从2014年6月20日开始 (v1.0) "),
          );
           $this->load->view('no3/infokaixiview',$data);
	}
