...
<html lang="en">
    ...
    <body>
        ...
        <tr>
             <td><i class="icon-time bigger-110 hidden-480"></i>${date}</td>
            <td class="center">${userid}</td>
            <td>${registertime}</td>
            <td>${viplevel}</td>
            <td class="hidden-480">${level}</td>
            <td>${totalonlinetime}</td>
            <td class="hidden-480">${totalwinscore}</td>
            <td>${winscore}</td>
            <td>${gametype}</td>
            <td>${roomid}</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-green2">
                                             <h5><i class="icon-arrow-left"></i>游戏选择：<label id="mycurrentgameid">All(全部游戏0)</label>；房间选择：<label id="mycurrentchannelid">All（全部房间:10000）</label>模式选择：<label id="mycurrentmodeid">赢分排名（1）</label></h5>
                                        ...
                                        <div class="widget-toolbox padding-8 clearfix">
                                             ...
                                             <div class="widget-toolbar no-border pull-left" style="margin-top:-2px;">
                                                ...
                                                <ul class="dropdown-menu dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                        ...
                                                        <li>
                                                            <a href="javascript:changemode('1','赢分排名(1)')">赢分排名(1)</a>
                                                        </li>
                                                        
                                                        <li>
                                                            <a href="javascript:changemode('0','输分排名(0)')">输分排名(0)</a>
                                                        </li>
                                            ...
                                            <input type="text" id="mystarttime" placeholder="指定时间" value="<?php echo date('Y-m-d', time() - 2 * 24 * 60 * 60) ?>" class="col-xs-10 col-sm-2" style = "height:34px;width:160px;"/> 
   ...
   <!-- <script src="../res/jsrender/jsrender.min.js"></script>  -->
    ...
    function get_tablebody(itemhead,itembody){
     ...
     function changemode(channelid, channelname) {
        offset = 0;
        m_modeid = channelid;
        m_modename = channelname;
        $("#mycurrentmodeid").html(channelname);
    }
 ...
 /*
        ...
        jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshun2/get_reporttotal_data", packet, onsuccess, onerrors);
