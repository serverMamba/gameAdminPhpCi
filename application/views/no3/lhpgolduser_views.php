								...
								<div class="col-xs-12 col-sm-12 widget-container-span">
									<div class="widget-box">		
										<div class="widget-toolbox padding-8 clearfix">
											<form action="<?php echo site_url('no3/lhpgolduser/index');?>" style="float:left;" class="form-horizontal">
													...
													<table id="sample-table-2"
														...
														<?php if(!empty($lhpgoldrecord_list)){ foreach ($lhpgoldrecord_list as $v){ ?>
															<tr>
																...
																<td><?php echo $v['duihuan_gold']; ?></td>
																<td><?php echo $v['fanzhuan_gold']; ?></td>
																<td><?php echo $v['cha_gold']; ?></td>
