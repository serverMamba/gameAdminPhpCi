...
class Wanshun2 extends MY_Controller {
	public function __construct() {
     ...
     public function get_reporttotal_data() {
        ...
        $modeid = $this->input->get_post('gameid');

        $roomid = $this->input->get_post('roomid');
        
        $res = $this->wanshun1_model->get_total_static2($starttime, $gameid,$modeid,  $roomid);
    ...
    public function index() {
        ...
        $data =array(
               ...
               "choose" => array("father"=>"运营报表","child"=>"玩家每日净分排序100名"),
               "header1" => array("father"=>"运营报表","child"=>"玩家每日净分排序100名"),
               "header2" => array("father"=>"运营数据总表","child"=>"玩家每日净分排序100名"),
               "header3" => array("father"=>"运营数据总表后台创建于2014年6月13日","child"=>" 游戏运营从2014年6月25日开始 (v1.0) "),
          );
           $this->load->view('no3/wanshun2_view',$data);
	}
