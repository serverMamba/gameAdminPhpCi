...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${itemtype}</td>
            <td class="hidden-480">${dropitemcount}</td>
            <td>${itemcountbefore}</td>
            <td>${itemcountafter}</td>
            <td><i class="icon-time bigger-110 hidden-480"></i>${droptime}</td>
        </tr>
    </script>
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>掉落道具记录  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
            ...
            <th>掉落前数量</th>
              <th>掉落后数量</th>
             <th><i class="icon-time bigger-110 hidden-480"></i>掉落时间</th>
        </tr>
                                                    </thead>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            function onsuccess(data) {
                ...
                {
                    datax["detail"][itemx]["itemtype"] = itemdisx[parseInt(  datax["detail"][itemx]["itemtype"])];
                    datax["detail"][itemx]["itemcountafter"] =parseInt(datax["detail"][itemx]["dropitemcount"]) +parseInt(datax["detail"][itemx]["itemcountbefore"]);
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish6/get_exchange_data", packet, onsuccess, onerrors);
        }
