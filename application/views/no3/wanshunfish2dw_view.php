...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${comparebetvalue}</td>
            <td class="hidden-480">${compareresult}</td>
            <td>${scorebefore}</td>
            <td class="hidden-480">${scoreafter}</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>捕水果机猜大小记录  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish2dw/get_exchange_data", packet, onsuccess, onerrors);
        }
