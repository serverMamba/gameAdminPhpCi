...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${taskmode}</td>
            <td>${id}</td>
            <td class="hidden-480">${name1}</td>
            <td>${couponnum}</td>
            <td class="hidden-480">${name2}</td>
            <td>${chipnum}</td>
            <td><i class="icon-time bigger-110 hidden-480"></i>${finishtime}</td>
        </tr>
    </script>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>游戏选择：<label id="mycurrentgameid">全部（10000）</label>模式选择：<label id="mycurrentmodeid">系统任务（1）</label></h5>
                                         ...
                                         <div class="widget-toolbox padding-8 clearfix">
                                            ...
                                            <div class="widget-toolbar no-border pull-left" style="margin-top:-2px;">
                                                ...
                                                <ul class="dropdown-menu dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                    ...
                                                    <li>
                                                         <a href="javascript:changemode('1','系统任务（1）')">系统任务（1）</a>
                                                    </li>
                                                    
                                                     <li>
                                                         <a href="javascript:changemode('2','每日任务（2）')">每日任务（2）</a>
                                                    </li>
                                                ...
                                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                    <thead id="targethead">
                                                        <tr>
                                                            <th class="center">userID</th>
                                                            <th>帐号</th>
                                                            <th class="hidden-480">游戏</th>
                                                             <th>任务类型</th>
                                                            <th>任务名称</th>
                                                            <th class="hidden-480">奖励物品A</th>
                                                            <th>数目</th>
                                                            
                                                            <th class="hidden-480">奖励物品B</th>
                                                            <th>数目</th>

                                                            <th><i class="icon-time bigger-110 hidden-480"></i>完成时间</th>
                                                        </tr>
                                                    </thead>
    ...
    <script type="text/javascript">
        ...
        var m_gameid = 10000;
        var m_gamename = "全部(10000)";
        
        var m_modeid = 1;
        var m_modename = "系统任务(1)";
       ...
       var taskname1 = new Array();
        ...
        function get_online_data() {
            ...
            function onsuccess(data) {
                ...
                for (var itemx in datax["detail"])
                {
                   // datax["detail"][itemx]["eventtype"] = eventitem[datax["detail"][itemx]["eventtype"]];
                    ...
                    datax["detail"][itemx]["beginmargin"]  = datax["detail"][itemx]["margin"] - datax["detail"][itemx]["changenum"];
                    // datax["detail"][itemx]["changenum1"]  = get_productnum2[ datax["detail"][itemx]["productid"]];
                    datax["detail"][itemx]["gameid"]  =   gamename1[datax["detail"][itemx]["gamecode"]];// productgamename2[ datax["detail"][itemx]["productid"]];
                   // datax["detail"][itemx]["productname"]  = productname2[ datax["detail"][itemx]["productid"]];
                   
                     datax["detail"][itemx]["id"]  =   taskname1[datax["detail"][itemx]["id"]];
                      datax["detail"][itemx]["taskmode"]  =  m_modename;
                     
                      datax["detail"][itemx]["name1"]  =   "兑换券";
                       datax["detail"][itemx]["name2"]  =   "金豆";
                }
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infotask/get_task_data", packet, onsuccess, onerrors);
        }
        ...
        function changemode(modeid, modename) {
            m_modeid = modeid;
            m_modename = modename;
            beginindex = 1;
            $("#mycurrentmodeid").html(modename);
            get_online_data();
        }
