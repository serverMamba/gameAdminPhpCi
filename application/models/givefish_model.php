 ...
 * 支付相关
 */
class givefish_model extends MY_Model {
    var $db = null;
    ...
    public function __construct() {
     ...
     public function get_givefish_his($num,$userid,$userid1,$gameid,$mystarttime,$myendtime,$account,$account1,$beginindex) {
        ...
        $where  = "where accepttime  >= '$mystarttime 00:00:00' and  accepttime <= '$myendtime 23:59:59'";
        
        $order="";
        
     
        if (!empty($userid)) {
            $where  = $where ." and fromuserid = $userid " ;
        }
        ...
        for($ii = $startx ;$ii<= $endx;$ii=$ii+60*60*24*30){
             ...
             $tablename = "CASINOPRESENTITEMHISTORY".date('Ym', $ii);
        ...
        $sql = "select * from $sqltable order by accepttime desc limit   $beginindex , 20 ";
