...
class Wanshun1 extends MY_Controller {
	public function __construct() {
        ...
        $res = $this->wanshun1_model->get_total_static1($starttime,  $endtime, $gameid,  $roomid);
    ...
    public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           {
           // $gamecodehuang = array_merge_recursive($this->config->item('gamecodehuang'),$this->config->item('gamelist'));
        ...
        $data =array(
               ...
               "choose" => array("father"=>"运营报表","child"=>"玩家净分分布"),
               "header1" => array("father"=>"运营报表","child"=>"玩家净分分布"),
               "header2" => array("father"=>"运营数据总表","child"=>"玩家净分分布 "),
               "header3" => array("father"=>"运营数据总表后台创建于2014年6月13日","child"=>" 游戏运营从2014年6月25日开始 (v1.0) "),
          );
           $this->load->view('no3/wanshun1_view',$data);
	}
