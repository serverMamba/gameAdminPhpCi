...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${areabetcount}</td>
            <td class="hidden-480">${bettimes}</td>
            <td>${totalbetscore}</td>
            <td class="hidden-480">${rewardtype}</td>
            <td>${gameresult}</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>水果机游戏记录  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            function onsuccess(data) {
                ...
                for (var itemx in datax["detail"])
                {
                  ...
                  //  datax["detail"][itemx]["gameid"]  =   gamename1[datax["detail"][itemx]["gamecode"]];
                    ...
                    datax["detail"][itemx]["gameresult"]  =   bb[datax["detail"][itemx]["gameresult"]];
                 }
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish1dw/get_exchange_data", packet, onsuccess, onerrors);
        }
