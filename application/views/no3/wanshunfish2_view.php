...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${skilltype}</td>
            <td class="hidden-480">${skillnumberbefore}</td>
            <td>${skillnumberafter}</td>
            <td class="hidden-480">${secondmoneybefore}</td>
            <td>${secondmoneyafter}</td>
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>捕鱼使用技能记录  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
            ...
            <th>开始钻石数量</th>
            <th>结束钻石数量</th>
            <th><i class="icon-time bigger-110 hidden-480"></i>使用时间</th>
        </tr>
                                                    </thead>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish2/get_exchange_data", packet, onsuccess, onerrors);
        }
