 ...
 * 支付相关
 */
class jinfen_model extends MY_Model {
    var $db = null;
    ...
    public function __construct() {
     ...
     public function get_jinfen_his($userid,$gameid,$mystarttime,$myendtime,$account,$beginindex) {
        ...
        $where  = "where record_timestamp  >= '$mystarttime' and  record_timestamp <= '$myendtime'";
        ...
        $tabsub = "ppCASINOGAMERECORD_MJ2P_";
        ...
        $sql1 = "select count(*) as count from (select user_id from $sqltable  group by user_id ) aaa";
