...
class Reportpcchis extends MY_Controller {
	...
	public function get_his_data() {
		...
		$res = $this->his_pcc_model->get_hispccmsg ( strtotime($starttime), strtotime($endtime) );
	...
	public function index() {
		...
		$this->load->view ( 'no3/reportpcchisview', $data );
	}
