...
class Reportmanage extends MY_Controller {
   ...
   public function get_reporttotal_data() {
        ...
        $res = $this->totalreport_model->get_total_static($time,$key,$gameid,$channel);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"运营报表","child"=>"运营渠道管理"),
               "header1" => array("father"=>"运营报表","child"=>"运营渠道管理"),
               "header2" => array("father"=>"运营渠道管理","child"=>"管理运营渠道数据明细 "),
               "header3" => array("father"=>"运营渠道管理后台创建于2014年6月13日","child"=>" 游戏运营从2014年6月25日开始 (v1.0) "),
          );
           $this->load->view('no3/reportmanageview',$data);
	}
