												...
												<table id="sample-table-2"
													...
													<?php foreach ($statistics_list as $k=>$v){ ?>
														<tr>
															...
															<td><?php echo $v['recharge_chips']; ?></td>
															<td><?php echo $v['cash_chips']; ?></td>
															<td><?php echo $v['choushui_chips']; ?></td>
															<td><?php echo $v['register_chips']; ?></td>
															<td><?php echo $v['bind_phone_chips']; ?></td>
															<td><?php echo $v['add_chips']; ?></td>
															<td><?php echo $v['change_chips']; ?></td>
															<td><?php echo $v['add_chips'] - $v['change_chips']; ?></td>
														</tr>
													<?php } ?>
													</tbody>
												</table>
