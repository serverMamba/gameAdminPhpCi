...
class Infojinfen extends MY_Controller {
	public function __construct() {
     ...
     public function get_jinfen_data() {
       $this->load->model('jinfen_model');
      ...
      // }
       ...
       $res = $this->jinfen_model->get_jinfen_his($userid,$gameid,$mystarttime,$myendtime,$account,$beginindex);
        ...
        if (file_exists($myfilename)) {
          ...
          // }
           ...
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"玩家竞分报表"),
               "header1" => array("father"=>"客服管理","child"=>"玩家竞分报表"),
               "header2" => array("father"=>"玩家竞分报表","child"=>"显示玩家的竞分状态。 "),
               "header3" => array("father"=>"玩家竞分报表后台创建于2014年6月20日","child"=>" 游戏运营从2014年6月25日开始 (v1.0) "),
          );
           $this->load->view('no3/infojinfenview',$data);
	}
