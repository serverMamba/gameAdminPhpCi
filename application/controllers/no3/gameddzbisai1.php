...
class Gameddzbisai1 extends MY_Controller {
	public function __construct() {
       ...
       public function save_gamemessage_data(){
           ...
           $ret=$this->gameddzbisai->save_gamemessage_data($id,$gamecode,$roomid,$inter,$msg); 
           echo json_encode( $ret);
        }
        ...
        if (file_exists($myfilename)) {
         ...
         //  }
           ...
           $data =array(
               ...
               "choose" => array("father"=>"运营管理","child"=>"斗地主比赛场奖项"),
               "header1" => array("father"=>"运营管理","child"=>"斗地主比赛场奖项"),
               "header2" => array("father"=>"斗地主比赛场奖项","child"=>"斗地主比赛奖项的后台管理"),
               "header3" => array("father"=>"斗地主比赛场奖项管理后台创建于2015年1月26日","child"=>" 游戏运营从2015年2月1日开始 (v1.0) "),
          );
           $this->load->view('no3/gameddzbisai1view',$data);
	}
