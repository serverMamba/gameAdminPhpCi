...
class Reportshop extends MY_Controller {
   ...
   public function get_reportshop_data() {
    ...
    //    $myfilename = "/var/www/html/smc/log/$key-$gameid-$time-$channel.log";
        ...
        $res = $this->shopreport_model->get_shop_static($time,$key,$gameid, $channel);
    ...
    public function index() {
        ...
        $usernamezz = $_COOKIE['SMC_NO3_YG'];
         ...
         //  {
           ...
           // $gamecodehuang = $this->config->item('gamecodehuang')+$this->config->item('gamecode');
          //  $channellisthuang = $this->config->item('channellisthuang')+$this->config->item('channellist');

         //  }
           
           
          // print_r($channellisthuang);
        ...
        $data = array(
            ...
            "choose" => array("father" => "运营报表", "child" => "商城报表"),
            "header1" => array("father" => "运营报表", "child" => "商城报表"),
            "header2" => array("father" => "商城报表", "child" => "报告商城运行状态！ "),
            "header3" => array("father" => "商城报表创建于2014年6月4日", "child" => " 游戏运营从2014年6月15日开始 (v1.0) "),
        );
        $this->load->view('no3/reportshopview', $data);
    }
