...
<html lang="en">
    ...
    <body>
        ...
        <tr>
            ...
            <th>userID</th>
            <th>gamecode</th>
             <th><i class="icon-time bigger-110 hidden-480"></i>feedbacktime</th>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>玩家意见统计</h5>
       ...
       var taskname1 = new Array();
        ...
        function get_online_data() {
          ...
          // alert( gamename1[$("#form-field-select-3").val()]);
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish9/get_zhanshi_data", packet, onsuccess, onerrors);
        }
