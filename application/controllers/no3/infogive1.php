...
class Infogive1 extends MY_Controller {
	public function __construct() {
       ...
       public function get_give_data() {
       $this->load->model('give1_model');
       ...
       $res = $this->give1_model->get_give_his($num,$userid,$gameid,$mystarttime,$myendtime,$account,$beginindex);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"玩家赠送记录排行"),
               "header1" => array("father"=>"客服管理","child"=>"玩家赠送记录排行"),
               "header2" => array("father"=>"玩家赠送记录排行","child"=>"在线人数实时统计 "),
               "header3" => array("father"=>"玩家赠送记录排行后台创建于2014年10月18日","child"=>" 游戏运营从2014年10月20日开始 (v1.0) "),
          );
           $this->load->view('no3/infogive1view',$data);
	}
