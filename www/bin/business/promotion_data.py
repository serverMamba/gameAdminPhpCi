...
def update_stat(dict_stat, promotion_id, field_name, field_value):
	if promotion_id in dict_stat:
		channel_stat = dict_stat[promotion_id]
		if field_name in channel_stat:
			dict_stat[promotion_id][field_name] += field_value
		else:
			dict_stat[promotion_id][field_name] = field_value
	else:
		channel_stat = {}
		channel_stat[field_name] = field_value
		dict_stat[promotion_id] = channel_stat

def do_single_stat(cursor, set_table_name, sql, promotion_id_pos, dict_field_name_pos):
	...
	for row in records:
		promotion_id = int(row[promotion_id_pos])
		for field_name in dict_field_name_pos:
			field_pos = dict_field_name_pos[field_name]
			update_stat(dict_stat, promotion_id, field_name, row[field_pos])		
...
table_name = "CASINOPROMOTIONSTAT"
sql = "select total_user_count, promotionid from %s where statistics_date = '%s'"%(table_name, stat_date_yesterday)
...
sql = "select count(distinct l.loginmac) as maccount, count(distinct l.userid) as count,c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid group by c.promotion_id"%(table_name_login)
dict_field_name_pos.clear()
...
sql = "select count(distinct registable.registermac) as count, c.promotion_id from %s as registable join CASINOUSERCHANNEL c on c.user_id = registable.userid where registable.newdevice = 1 and exists(select * from %s as logintable where logintable.loginmac = registable.registermac) group by c.promotion_id"%(table_name_register_1day_before, table_name_login)
dict_field_name_pos.clear()
...
sql = "select count(distinct registable.registermac) as count, c.promotion_id from %s as registable join CASINOUSERCHANNEL c on c.user_id = registable.userid where registable.newdevice = 1 and exists(select * from %s as logintable where logintable.loginmac = registable.registermac) group by c.promotion_id"%(table_name_register_7day_before, table_name_login)
dict_field_name_pos.clear()
...
sql = "select count(*) as count, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid group by c.promotion_id"%(table_name_register)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_register)
sql = "select count(*) as count, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid where l.newdevice = 1 group by c.promotion_id"%(table_name_register)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_register)
sql = "select count(*) as count, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid where l.guest = 1 group by c.promotion_id"%(table_name_register)
dict_field_name_pos.clear()
...
sql = "select count(distinct regishis.userid) as count, c.promotion_id from %s as regishis join CASINOUSERCHANNEL c on c.user_id = regishis.userid where regishis.newdevice = 1 and exists (select * from %s as gamehis where eventtype in (1, 2) and gamehis.userid = regishis.userid) group by c.promotion_id"%(table_name_register, table_name_gamehis)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earn_score) as ddz_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id WHERE l.room_id > 0 group by c.promotion_id"%(table_name_ddz)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_ddz)
sql = "select SUM(l.earn_score) as huanle_ddz_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_ddz)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_ddz)
sql = "select SUM(l.earn_score) as laizi_ddz_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_ddz)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earn_score) as zjh_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_zjh)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_zjh)
sql = "select SUM(l.earn_score) as zjh_bairen_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_zjh)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earn_score) as hongheidz_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_hongheidz)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earn_score) as malai_niuniu_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_niuniuml)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earn_score) as sangong_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_sangong)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earn_score) as niuniu_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_niuniu)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_niuniu)
sql = "select SUM(l.earn_score) as qiangzhuang_niuniu_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id group by c.promotion_id"%(table_name_niuniu)
dict_field_name_pos.clear()
...
sql = "select SUM(l.earnscore*-1) as buyu_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid group by c.promotion_id"%(table_name_buyu)
dict_field_name_pos.clear()
...
sql = "select SUM(l.realwinscore*-1) as fruit_money, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid group by c.promotion_id"%(table_name_fruit)
dict_field_name_pos.clear()
...
set_table_name.clear()
set_table_name.add(table_name_fruit)
sql = "select SUM(scorebefore - scoreafter) as fruit_compare_money, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid group by c.promotion_id"%(table_name_fruit)
dict_field_name_pos.clear()
...
sql = "select SUM(l.costitemcountbefore-l.rewarditemcountafter) as bao_money, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid group by c.promotion_id"%(table_name_bao)
dict_field_name_pos.clear()
...
sql = "select (0 - sum(l.goldchange)) as lhp_choushui, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.user_id WHERE goldchange != 0 group by c.promotion_id"%(table_name_lhp)
dict_field_name_pos.clear()
...
for i in range(0, 7):
	...
	sql = "select distinct(l.userid) as userid, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid"%(table_name_temp)
	print sql
	cursor.execute(sql)
	records = cursor.fetchall()
	for row in records:
	...
	sql = "select distinct(l.loginmac) as device, c.promotion_id from %s l join CASINOUSERCHANNEL c on c.user_id = l.userid"%(table_name_temp);
	print sql
	cursor.execute(sql)
	records = cursor.fetchall()	
	for row in records:
...
'''
table_name = "smc_log_order_promotion"
sql = "select promotion_id,SUM(choushui_money) AS choushui_money from %s where date1 = '%s' AND promotion_id > 0 group by promotion_id"%(table_name, pay_stat_date)
...
sql = "SELECT SUM(o.money) AS pay_total_money,u.promotion_id FROM %s o JOIN smc_user u ON u.user_id = o.user_id WHERE o.status = 1 AND o.add_time >= %s AND o.add_time < %s GROUP BY u.promotion_id"%(table_name, today_time,today_time_end)
...
#总付费用户
sql = "SELECT count(distinct(o.user_id)) AS pay_user_count,u.promotion_id FROM %s o JOIN smc_user u ON u.user_id = o.user_id WHERE o.status = 1 AND o.add_time >= %s AND o.add_time < %s GROUP BY u.promotion_id"%(table_name, today_time,today_time_end)
set_table_name.clear()
set_table_name.add(table_name)
dict_field_name_pos.clear()
...
sql = "SELECT count(o.id) AS pay_total_num,u.promotion_id FROM %s o JOIN smc_user u ON u.user_id = o.user_id WHERE o.status = 1 AND o.add_time >= %s AND o.add_time < %s GROUP BY u.promotion_id"%(table_name, today_time,today_time_end)
set_table_name.clear()
set_table_name.add(table_name)
dict_field_name_pos.clear()
...
sql = "SELECT SUM(cash_money) AS cash_money,SUM(cash_money - real_cash_money) AS choushui_money, sum(alifee) as alifee, promotion_id FROM %s WHERE status = 1 AND update_time >= %s AND update_time <= %s GROUP BY promotion_id"%(table_name, today_time,today_time_end)
...
table_name = "smc_cash_order"
sql = "SELECT SUM(cash_money) AS cash_money1,SUM(cash_money - real_cash_money) AS choushui_money1, sum(alifee) as alifee1, promotion_id FROM %s WHERE status = 1 AND update_time >= %s AND update_time <= %s GROUP BY promotion_id"%(table_name, today_time,today_time_end)
...
insert_params = "(statistics_date, promotionid"
...
for promotion_id in dict_stat:
	...
	single_info.append(promotion_id)
...
cursor = conn.cursor()
sql = "delete from CASINOPROMOTIONSTAT where statistics_date = '%s'"%(stat_date)
cursor.execute(sql)
conn.commit()

sql = "insert into CASINOPROMOTIONSTAT %s"%(insert_params)
print sql
print insert_info
