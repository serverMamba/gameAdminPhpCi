...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${apply_fee}</td>
            <td class="hidden-480">${user_placing}</td>
            <td>${user_reward}</td>
            <td>${user_score_begin}</td>
            <td>${user_score_end}</td>
            <td><i class="icon-time bigger-110 hidden-480"></i>${start_time}</td>
            <td>${game_time}</td>
            <td><i class="icon-time bigger-110 hidden-480"></i>${stop_time}</td>
        </tr>
    </script>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>玩家PK赛记录</h5>
    ...
    <script type="text/javascript">
        ...
        function get_online_data(eventid) {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infopk/get_pk_data", packet, onsuccess, onerrors);
        }
