...
<html lang="en">
    ...
    <body>
       ...
       <div id="modal-tree-items" class="modal" tabindex="-1">
        ...
        <tr >
            ...
            <td class="hidden-480"><input type="text" id="version${upgradetag}${modelname}" value="${version}" placeholder="最新版本号修改" class="col-xs-20 col-sm-10" style="margin-left: 10px;width:330px;" /></td>
             <td class="hidden-480"><input type="text" id="overversion${upgradetag}${modelname}"  value="${overversion}" placeholder="过期版本号修改" class="col-xs-20 col-sm-10" style="margin-left: 10px;width:330px;" /></td>
            <td><button onclick="javascript:updateconfig('${upgradetag}','${modelname}',this)" class="btn btn-xs btn-success " style="margin-top:1px;">
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>包模块升级服务器管理</h5>
                                                    ...
                                                    <thead id="targethead">
                                                        <tr>
                                                            <th>模块名称</th>
                                                             <th>运营的版本号</th>
                                                             <th >运营的过期版本号</th>
                                                             <th style="width:250px">运营的版本号修改</th>
                                                             <th style="width:250px">运营的过期版本号修改</th>
                                                            <th>实际操作</th>
                                                          </tr>
                                                    </thead>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/packetmodel/get_proxy_data", packet, onsuccess, onerrors);
        }
        
        
        function updateconfig(upgradetag,modelname,obj){
             var packet = {
                action: 'get_online_data',
                upgradetag : upgradetag,
                modelname : modelname ,
                version  :  $(obj).parent().prev().prev().children('input').val(),
                overversion  :  $(obj).parent().prev().children('input').val()
               };
            function onsuccess(data) {
                alert("修改成功")
                     // reflesh();
           ...
           jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/packetmodel/update_proxy_data", packet, onsuccess, onerrors);
        }
