...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${newbetindex}</td>
            <td class="hidden-480">${oldbetindex}</td>
            <td>${secondmoneybefore}</td>
            <td class="hidden-480">${secondmoneyafter}</td>
            <td>${moneybefore}</td>
            <td class="hidden-480">${moneyafter}</td>
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
            ...
            <th><i class="icon-time bigger-110 hidden-480"></i>解锁时间</th>
        </tr>
                                                    </thead>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish3/get_exchange_data", packet, onsuccess, onerrors);
        }
