...
<?php } ?>
    ...
    function get_online_data() {
        ...
        jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/castshopordersw/get_castshoporder_data", packet, onsuccess, onerrors);
    }
    ...
    function congzhi(mobile, price, orderid, statusid) {
        ...
        jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/castshopordersw/send_number", packet, onsuccess, onerrors);
    }
    ...
    function savecommit() {
        ...
        jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/castshopordersw/save_config_data", packet, onsuccess, onerrors);
    }
