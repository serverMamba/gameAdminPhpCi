...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            <td>${userid}</td>
            <td>${rewardtype}</td>
            <td class="hidden-480">${rewardcountbefore}</td>
            <td>${rewardcountafter}</td>
            <td>${paycontributionbefore}</td>
             <td>${paycontributionafter}</td>
              <td>${gametype}</td>
            <td>${gametime}</td>
        </tr>
    </script>
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
            ...
            <div class="main-content">
                        ...
                        <!--    <?php $this->load->view('no3/common/nav_top2', $header3); ?>  -->
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>幸运抽奖记录</h5>
                                ...
                                <div class="widget-toolbox padding-8 clearfix">
                                            ...
                                            <button onclick="javascript:reflesh(2)" class="btn btn-xs btn-success " style="margin-top:1px;margin-left:10px;;height:31px;">
                ...
                <th class="center">获奖物品类型</th>
                <th class="center">获奖物品初始数量</th>

                <th>获奖物品结束数量</th>
                <th class="hidden-480">抽前充值贡献度</th>
                 <th>抽后充值贡献度</th>
                  <th>游戏类型</th>
                   <th>抽奖时间</th>
                                                        </tr>
       ...
       ?>
        ...
        function get_online_data(num) {
            ...
            function onsuccess(data) {
                ...
                {
                    if(datax["detail"][itemx]["gametype"] == "193"){
                         datax["detail"][itemx]["rewardtype"]  =  itemstype1[datax["detail"][itemx]["rewardtype"]]; 
                    }else{
                       datax["detail"][itemx]["rewardtype"]  =  itemstype[datax["detail"][itemx]["rewardtype"]]; 
                    }
                    
                    datax["detail"][itemx]["gametype"] = items[datax["detail"][itemx]["gametype"]];
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infogivefishjiang/get_givefishjiang_data", packet, onsuccess, onerrors);
        }
