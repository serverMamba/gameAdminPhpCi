...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td class="hidden-480">${gamenumber}</td>
            <td>${roomid}</td>
            <td class="hidden-480">${applyfeechip}</td>
            <td>${userplacing}</td>
            <td>${rewardchip}</td>
            <td>${ rewardcoupon }</td>
            <td><i class="icon-time bigger-110 hidden-480"></i>${starttime}</td>
            <td><i class="icon-time bigger-110 hidden-480"></i>${stoptime}</td>
        </tr>
    </script>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>玩家话费赛记录</h5>
        ...
        function get_online_data(eventid) {
            ...
            function onsuccess(data) {
                ...
                */
                ...
                {
                    datax["detail"][itemx]["room_id"] = eventitem[datax["detail"][itemx]["room_id"]];
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infohf/get_hf_data", packet, onsuccess, onerrors);
        }
