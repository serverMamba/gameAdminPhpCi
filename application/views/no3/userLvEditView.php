                                ...
                                <div class="widget-box">
                                    <div class="widget-body">
                                        <div class="widget-main" style="padding: 0;">
                                            <form class="form-horizontal" action="<?php echo site_url('no3/userLv/edit'); ?>" method="post">
                                                <div class="form-group">
                                                    <div class="col-sm-4">
                                                        <input type="hidden" class="form-control" id="title" name="id"
                                                               placeholder="" value="<?php if (isset($oldValue['id'])) {
                                                            echo $oldValue['id'];
                                                        } ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="title" name="name"
                                                               placeholder="请输入等级名称" value="<?php if (isset($oldValue['name'])) {
                                                            echo $oldValue['name'];
                                                        } ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="title" name="upPrice"
                                                               placeholder="请输入金额" value="<?php if (isset($oldValue['upPrice'])) {
                                                            echo $oldValue['upPrice'];
                                                        } ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <textarea class="form-control" id="title" name="note" value="<?php if (isset($oldValue['note'])) {
                                                            echo $oldValue['note'];
                                                        } ?>">
                                                        </textarea>
                                                    </div>
