...
<html lang="en">
    ...
    <body>
        ...
        <tr>
            ...
            <td class="center" id="mygameid${GameCode}">${GameCode}</td>
            <td class="center">${Version}</td>
   
            <td class="hidden-480"><input type="text" id="myversionid${GameCode}" placeholder="版本号" class="col-xs-20 col-sm-10" style="margin-left: 10px;width:330px;" /></td>
            <td><button onclick="javascript:saveconfig(${GameCode})" class="btn btn-xs btn-success " style="margin-top:1px;">
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/jsversion/get_jsversion_data", packet, onsuccess, onerrors);
        }
        
        
        function saveconfig(version){
            
            var gameid = $("#mygameid"+version).html();
            
             var newversion = $("#myversionid"+version).val();
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/jsversion/save_jsversion_data", packet, onsuccess, onerrors);
        }
