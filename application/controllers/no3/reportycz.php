...
class Reportycz extends MY_Controller {
	public function __construct() {
     ...
     public function get_his_data() {
       ...
       public function monthpay() {
        ...
        $ret = $this->pay_model->get_monthpay($year, $month);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"运营报表","child"=>"月充值分析"),
               "header1" => array("father"=>"运营报表","child"=>"月充值分析"),
               "header2" => array("father"=>"月充值分析","child"=>"用曲线的方式表达月充值分析"),
               "header3" => array("father"=>"月充值分析后台创建于2014年6月20日","child"=>" 游戏运营从2014年9月20日开始 (v1.0) "),
          );
           $this->load->view('no3/reportyczview',$data);
	}
