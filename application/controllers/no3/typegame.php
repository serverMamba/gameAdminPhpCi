...
class Typegame extends MY_Controller {
	public function __construct() {
		parent::__construct ( false, false );
		if (! $this->Common_model->isLogin ()) {
			redirect ( 'no3/login' );
		}
		if (! $this->Common_model->isPriv ( 'ywgl_jzsd' )) {
			redirect ( 'no3/index' );
		}
	...
	public function get_config_data() {
		...
		$this->load->model ( 'typename_model' );
		$ret = $this->typename_model->get_config_data ( $gamename, $mode );
		echo $ret;
	}
	public function save_config_data() {
		...
		$this->load->model ( 'typename_model' );
		$ret = $this->typename_model->save_all_configdata ( $gamename, $mode, $postdata );
		echo $ret;
	}
	public function index() {
		...
		$this->load->view ( 'no3/typenameview', $data );
	}
