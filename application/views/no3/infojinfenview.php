    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            <td class="center">${user_id}</td>
             <td>${account}</td>
            <td>${user_nickname}</td>
            <td class="hidden-480">${gamename}</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>竞分报表</h5>
       ...
       var taskname1 = new Array();
        ...
        function get_online_data() {
          ...
          // alert( gamename1[$("#form-field-select-3").val()]);
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infojinfen/get_jinfen_data", packet, onsuccess, onerrors);
        }
