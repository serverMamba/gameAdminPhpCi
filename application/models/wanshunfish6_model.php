...
class Wanshunfish6_model extends MY_Model {
    ...
    public function get_exchange_his($userid, $mystarttime, $myendtime, $beginindex){
        ...
        $dbtablesx = "CASINOFISHDROPITEMRECORD";
        ...
        if(strlen($mystarttime) !=0)  {$xx = strlen($where)>0? " and ":"" ; $where = $where.$xx." aa.droptime >= '$mystarttime'";}
        if(strlen($myendtime) !=0)  {$xx = strlen($where)>0? " and ":"" ; $where = $where.$xx." aa.droptime <= '$myendtime'";}
      //  if(strlen($paijuhao) !=0)  {$xx = strlen($where)>0? " and ":"" ; $where = $where.$xx." aa.game_number = '$paijuhao'";}
        
         $sql = "select * from $sqltable order by aa.droptime desc limit $beginindex , 20 ";
        ...
        if(strlen($where)>0)
        {
           $sql =  "select * from $sqltable where $where order by aa.droptime desc limit $beginindex ,20 "; 
