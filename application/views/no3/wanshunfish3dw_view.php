...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${costitemtype}</td>
            <td class="hidden-480">${costitemcount}</td>
            <td>${rewarditemtype}</td>
            <td class="hidden-480">${rewarditemcount}</td>
            <td>${costitemcountbefore}</td>
            <td class="hidden-480">${costitemcountafter}</td>
            
            <td class="hidden-480">${rewarditemcountbefore}</td>
            <td class="hidden-480">${rewarditemcountafter}</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>寻宝记录  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
        ...
        function get_online_data() {
            ...
            function onsuccess(data) {
                ...
                for (var itemx in datax["detail"])
                {
                   ...
                   datax["detail"][itemx]["rewarditemtype"]  =   bb[datax["detail"][itemx]["rewarditemtype"]];
                 }
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish3dw/get_exchange_data", packet, onsuccess, onerrors);
        }
