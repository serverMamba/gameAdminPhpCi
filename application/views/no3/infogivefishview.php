...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            <td>${fromuserid}</td>
            <td>${itemtype}</td>
            <td class="hidden-480">${itemcount}</td>
            <td>${touserid}</td>
            <td>${presenttime}</td>
            <td>${accepttime}</td>
        </tr>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>宝盒赠送记录报表</h5>
                                        ...
                                        <div class="widget-body">
                                            ...
                                            <div class="widget-main"  style ="padding:0;">
                                                ...
                                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                    <thead id="targethead">
                                                        <tr>
                                                            <th class="center">赠送者id</th>
                                                            <th class="center">宝盒类型</th>
                                                            <th class="center">宝盒数量</th>
                                                           
                                                            <th>获赠者id</th>
                                                            <th ><i class="icon-time bigger-110 hidden-480"></i>发起赠送时间</th>
                                                            <th><i class="icon-time bigger-110 hidden-480"></i>获赠时间</th>
        ...
        function get_online_data(num) {
            ...
            function onsuccess(data) {
                ...
                for (var itemx in datax["detail"])
                {
                  ...
                  if( datax["detail"][itemx]["itemtype"]  == "8" )  datax["detail"][itemx]["itemtype"]  ="银宝盒";
                   if( datax["detail"][itemx]["itemtype"]  == "9" )  datax["detail"][itemx]["itemtype"]  ="金宝盒";
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infogivefish/get_givefish_data", packet, onsuccess, onerrors);
        }
