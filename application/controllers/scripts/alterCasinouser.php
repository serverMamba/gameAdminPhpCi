...
//                    }
//
//                    $sql3 = 'alter table ' . $tableName . ' add column note varchar(1024) not null default "" comment "用户备注" after userTag';
//                    $ret3 = $db->query($sql3);
//                    if (!$ret3) {
...
//        }
        ...
        for ($i = 0; $i <= 15; $i++) {
            ...
            for ($j = 0; $j <= 15; $j++) {
                $tableName = 'casinouser_' . $j;
                $sql1 = 'alter table ' . $tableName . ' change column note note varchar(1024) not null default "" comment "用户备注"';
                $ret1 = $db->query($sql1);
            }
        }
    }
