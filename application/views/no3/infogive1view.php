                            ...
                            <div class="row">
                                ...
                                <div class="widget-toolbox padding-8 clearfix">
                                            ...
                                            <button onclick="javascript:reflesh(2)" class="btn btn-xs btn-success " style="margin-top:1px;margin-left:10px;;height:31px;">
                                                <span class="bigger-110">查询(赠送者)</span>

                                                <i class="icon-search icon-on-right"></i>
                                            </button>
                                            
                                            <button onclick="javascript:reflesh(3)" class="btn btn-xs btn-success " style="margin-top:1px;;height:31px;>
                                                <span class="bigger-110">查询(接受者)</span>
    ...
    <script type="text/javascript">
       ...
       var items = new Array();
        ...
        function get_online_data(num) {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infogive1/get_give_data", packet, onsuccess, onerrors);
        }
