...
<div class="common_table_div" style="width:98%">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#E8E8E8">
		...
		<?php if(empty($prime)):?>
			<tr>
				<td colspan="8" align="center">无任何精华微博</td>		
			</tr>
		<?php else:?>
			<?php foreach($prime as $var):?>
			<tr>
				...
				<td><a href="<?php echo $var['url']?>" target="_blank">查看微博</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $var['cancel_url']?>">取消精华</a></td>
			</tr>
			<?php endforeach;?>
		<?php endif;?>
			<tr>
