...
class AgentAccount extends CI_Controller {
	var $report_field = array ();
	public function __construct() {
		...
		$this->report_field = json_decode ( $this->config->item ( 'report_field' ), true );
		$this->load->model ( 'no3/Agent_account_model' );
	}
	public function index() {
		$data = array (
				...
				'agent_account_list' => $this->Agent_account_model->getAgentAccountList()
		);
