...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${itemtype}</td>
            <td class="hidden-480">${itemcountbefore}</td>
            <td>${itemcountafter}</td>
             <td><i class="icon-time bigger-110 hidden-480"></i>${changetime}</td>
        </tr>
    </script>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish5/get_exchange_data", packet, onsuccess, onerrors);
        }
