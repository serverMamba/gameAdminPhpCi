...
<div class="common_table_div">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<th colspan="2">当前Android版本信息</th>		
		</tr>
		<tr>
			<th align="left" width="25%">版本号：</th>
...
<div class="common_table_div">
	<form action="<?php echo site_url('softpub/android_upload')?>" method="post" enctype="multipart/form-data">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<th colspan="2">发布新版本</th>		
		</tr>
		<tr>
			<th align="left">新版本号:</th>
			<td><input type="text" name="version" id="version" value="<?php echo $version?>" /><button onclick="$('#version').val(parseInt($('#version').val())+1);return false;">点击+1</button></td>
		</tr>
		<tr>
