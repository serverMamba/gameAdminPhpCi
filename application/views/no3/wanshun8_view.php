...
<html lang="en">
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>游戏版本运营数据分析  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshun8/get_exchange_data", packet, onsuccess, onerrors);
        }
