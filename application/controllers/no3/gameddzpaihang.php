...
class Gameddzpaihang extends MY_Controller {
	public function __construct() {
       ...
       public function get_gamemessage_data(){
            $ret = $this->rank_model->get_profile_rank();
            echo json_encode( $ret);
        }
       
      
       public function insert_gamemessage_data() {
        $this->rank_model->save_gamemessage_data();
        echo "写入ok";
    }
    
     public function insert_gamemessage_datataiguo() {
        $this->rank_model->save_gamemessage_datataiguo();
        echo "写入ok";
    }
      ...
      //  {
       ...
       // }
        ...
        $data =array(
               ...
               "choose" => array("father"=>"运营管理","child"=>"斗地主排行奖励管理"),
               "header1" => array("father"=>"运营管理","child"=>"斗地主排行奖励管理"),
               "header2" => array("father"=>"斗地主排行奖励管理","child"=>"实施排行奖励规则 "),
               "header3" => array("father"=>"斗地主排行奖励管理后台创建于2014年12月26日","child"=>" 游戏运营从2015年1月1日开始 (v1.0) "),
          );
           $this->load->view('no3/gameddzpaihangview',$data);
	}
