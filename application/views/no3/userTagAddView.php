                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main" style="padding: 0;">
                                            <form class="form-horizontal" action="<?php if (isset($notice)) {
                                                echo site_url('no3/userTag/add/' . $notice['id']);
                                            } else {
                                                echo site_url('no3/userTag/add');
                                            } ?>" method="post">
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-1 control-label">标签名称</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="title" name="name"
                                                               placeholder="" value="<?php if (isset($notice)) {
                                                            echo $notice['title'];
                                                        } ?>">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label class="radio-inline">
                                                            <input type="radio" name="autoMoney"
                                                                   value="1" <?php if (!isset($notice) || $notice['is_carousel'] == 1) { ?> checked="checked" <?php } ?>>
                                                            是
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="autoMoney"
                                                                   value="2" <?php if (isset($notice) && $notice['is_carousel'] == 0) { ?> checked="checked" <?php } ?>>
                                                            否
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="title" name="sort"
                                                               placeholder="" value="<?php if (isset($notice)) {
                                                            echo $notice['title'];
                                                        } ?>">
                                                    </div>
