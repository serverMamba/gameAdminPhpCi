...
class Infopk extends MY_Controller {
...
public function get_pk_data() {
       ...
       */
       ...
       $res = $this->pk_model->get_pk_his($userid,$eventid,$mystarttime,$myendtime,$account,$beginindex);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"玩家PK赛记录"),
               "header1" => array("father"=>"客服管理","child"=>"玩家PK赛记录"),
               "header2" => array("father"=>"玩家PK赛记录","child"=>"玩家PK赛记录 "),
               "header3" => array("father"=>"玩家PK赛记录后台创建于2014年7月2日","child"=>" 游戏运营从2014年7月15日开始 (v1.0) "),
          );
           $this->load->view('no3/infopkview',$data);
	}
