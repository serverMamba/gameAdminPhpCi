...
<body style="background:url('<?php echo $base_url; ?>images/ppp.jpg') no-repeat;background-attachment:fixed;background-position: center;background-size:100% 100%;">
	...
	<div class="table-responsive">
		<table class="table table-bordered table-condensed">
			...
			<tbody>
				<tr>
					<td align="center" style="color:#b4ff00;"><?php echo '全部'; ?></td>
					<td align="center" style="color:#b4ff00;"><?php echo $total['total_pay_show'].'元'; ?></td>
					<td align="center" style="color:#b4ff00;"><?php echo $total['total_cash'].'元'; ?></td>
					<td align="center" style="color:#b4ff00;"><?php echo $total['total_cash_choushui'].'元'; ?></td>
					<td align="center" style="color:#b4ff00;"><?php echo $total['total_choushui'].'元'; ?></td>
				</tr>
