								...
								<div class="col-xs-12 col-sm-12 widget-container-span">
									<div class="widget-box">
										<div class="widget-toolbox padding-8 clearfix">
											<form action="<?php echo site_url('no3/userRegisterList/index');?>">
												...
												<table id="sample-table-2"
													...
													<?php foreach ($user_list as $v){ ?>
														<tr style="cursor:pointer;" onclick="toUserInfo('<?php echo site_url('no3/infodetail').'?user_id='.$v['userid'];?>')">
															...
															<td><?php echo $v['registermac']; ?></td>
															<td><?php echo $channel_list[$v['channelid']]; ?></td>
															<td><?php if($v['guest']){echo '是'; }else{echo '否'; } ?></td>
														</tr>
													<?php } ?>
													</tbody>
												</table>
