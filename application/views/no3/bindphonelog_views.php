								...
								<div class="col-xs-12 col-sm-12 widget-container-span">
									<div class="widget-box">		
										<div class="widget-toolbox padding-8 clearfix">
											<form action="<?php echo site_url('no3/bindphonelog/index');?>" style="float:left;" class="form-horizontal">
	                                            ...
	                                            <input value="<?php if($query['mobile']){echo $query['mobile']; }?>" type="text" placeholder="手机号" name="mobile"  class="col-xs-10 col-sm-2" style = "margin-left:5px;height:34px;width:80px;"/> 
											...
											<div class="widget-main" style="padding: 0;">
												<form action="" method="post" name="of" id="of">
													<table id="sample-table-2"
														...
														<tbody id="tbody">
														<?php if(!empty($bindphonelog_list)){ foreach ($bindphonelog_list as $v){ ?>
															<tr>
