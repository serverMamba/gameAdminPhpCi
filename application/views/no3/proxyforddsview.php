...
<html lang="en">
    ...
    <body>
       ...
       <div id="modal-tree-items" class="modal" tabindex="-1">
            <div class="modal-dialog" style="width:450px;margin-top: 100px;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="blue bigger">Proxy服务器切换</h4>
                    </div>
        ...
        <tr >
            ...
            <td class="center" id="myTag${gamename}">${gamename}</td>
            <td class="center" >${serverip}</td>
             <td class="center" >${BindingAddress}</td>
              <td class="center" >${ConnectAddress}</td>
   
            <td class="hidden-480"><input type="text" id="refid${gamename}${serveripcc}" placeholder="反向连接地址修改" class="col-xs-20 col-sm-10" style="margin-left: 10px;width:330px;" /></td>
            <td><button onclick="javascript:updateconfig('${gamename}','${serverip}','${BindingAddress}')" class="btn btn-xs btn-success " style="margin-top:1px;">
                                                <span class="bigger-110">提交</span>
                                                <i class="icon-ok icon-on-right"></i>
                                                
              
            </td>
            <td class="center" >切换后，已有连接依然继续运行</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>Proxy服务器切换</h5>
                                                ...
                                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                    <thead id="targethead">
                                                        <tr>
                                                            ...
                                                            <th>游戏标识</th>
                                                            <th>服务器IP</th>
                                                             <th style="width:350px">监听地址</th>
                                                             <th style="width:350px">反向连接地址</th>
                                                             <th style="width:350px">反向连接修改</th>
                                                            <th>实际操作</th>
                                                            <th>备注</th>
                                                          </tr>
                                                    </thead>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/proxyfordds/get_proxy_data", packet, onsuccess, onerrors);
        }
        ...
        function updateconfig(gamename,serverip,BindingAddress){
            ...
            function onerrors(data) {
              ...
              jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/proxyfordds/update_proxy_data", packet, onsuccess, onerrors);
        }
