 ...
 * 支付相关
 */
class castsys_model extends MY_Model {
	var $db = null;
	...
	public function get_cast_message() {
		$CI = &get_instance ();
		$db = $CI->load->database ( 'globalinfo', true );
		
		$query = $db->query ( "select * from  CASINOGLOBALINFO.CASINONOTIFICATIONINFO order by id desc;;" );
		$ret = $this->_dealwith_ret ( $query );
		return array (
