...
<html lang="en">
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-toolbox padding-8 clearfix">
                                            ...
                                            <div class="widget-toolbar no-border pull-left" style="margin-top:-2px;">
                                                ...
                                                <ul class="dropdown-menu dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                     <li>
                                                            <a href="javascript:changechannel('<?php echo 10000 ?>','<?php echo "All(所有渠道:10000)" ?>')"><?php echo "All(所有渠道:10000)" ?></a>
                                                        </li>
    ...
    <script type="text/javascript">
        ...
        var m_gameid = 10000;
        var m_gamename = "All(所有游戏:10000)";
        
        var m_channelid = 10000;
        var m_channelname = "All(所有渠道:10000)";
        ...
        var rowtitle = [{"key": "money30", "value": "30元"}, {"key": "money5", "value": "5元"}, {"key": "money2", "value": "2元"},
            {"key": "money10", "value": "10元"}, {"key": "money15", "value": "15元"}, {"key": "money50", "value": "50元"},
            {"key": "money100", "value": "100元"}, {"key": "money500", "value": "500元"},{"key": "money1000", "value": "1000元"},{"key": "money5000", "value": "5000元"},{"key": "moneyyk", "value": "VIP银卡"}, {"key": "moneyjk", "value": "VIP金卡"}, {"key": "moneyzs", "value": "VIP铂金卡"}];
        ...
        function ontime_dryxsc(time, key) {
            window.setTimeout(function() {
                if ( (rowdata["yxjshi"+time] !== undefined) && (rowdata["dryxrs"+time] !== undefined)) {
                    
                    var datax = eval("(" + rowdata["yxjshi"+time] + ")");
                    var datay = eval("(" + rowdata["dryxrs"+time] + ")");
                    ...
                    for (var item in datay) {
                     ...
                     if(parseFloat(datay["合计"])>0){
                        valuey =  datax["合计"]*60/datay["合计"];
                     }
 
                    rowdata[key+time] = valuex;
         ...
         function ontime_jdff(time, key) {
            window.setTimeout(function() {
                if ((rowdata["zczs"+time] !== undefined) && (rowdata["jjlq"+time] !== undefined)&& (rowdata["dljl"+time] !== undefined)&& (rowdata["rwjl"+time] !== undefined)&& (rowdata["zzf"+time] !== undefined)) {
        ...
        */
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/reportshop/get_reportshop_data", packet, onsuccess, onerrors);
