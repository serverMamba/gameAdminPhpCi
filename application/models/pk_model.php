...
class pk_model extends MY_Model {
    ...
    public function __construct() {
     ...
     public function get_pk_his($userid,$eventid,$mystarttime,$myendtime,$account,$beginindex) {
        ...
        */
        ...
        $sqltable ="(";
        $where = "where start_time  >= '$mystarttime' and  start_time <= '$myendtime'";
        ...
        if (!empty($userid)) {
         ...
         if ($eventid !="0") {
            $where =  $where ." and game_type = $eventid" ;
         }
        ...
        for($ii = $startx ;$ii<= $endx;$ii=$ii+60*60*24){
           ...
           //  $tablename = "CASINOOUTGAMESCOREOPERATIONHISTORY".date('Ymd', $ii);
            $tablename = "CASINOTOURNAMENTGAMERECORD_PK_".date('Ymd', $ii);
