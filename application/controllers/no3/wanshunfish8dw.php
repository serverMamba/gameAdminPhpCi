...
class Wanshunfish8dw extends MY_Controller {
	...
	public function get_reportgame_data() {
		$this->load->model ( 'wanshunfish8dw_model' );
		$starttime = $this->input->get_post ( 'starttime' );
		$endtime = $this->input->get_post ( 'endtime' );
		
		$res = $this->wanshunfish8dw_model->get_game_static ( $starttime, $endtime );
	...
	public function index() {
		...
		$this->load->view ( 'no3/wanshunfish8dw_view', $data );
	}
