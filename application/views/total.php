...
<div class="common_table_div" style="width:600px;">
    <form action="" method="get">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#E8E8E8" id="j_info_table">
            ...
            <tr>
                <th colspan="2">total_time</th>
                <th colspan="2">total_num</th>
            </tr>
            <?php foreach ($result as $v) {?> 
            <tr>
                <th colspan="2" align="left" width="30%"><?php echo $v['total_time'];?></th>
                <td colspan="2"><?php echo number_format($v['total_num']);?></td>
            </tr>
            <?php }?> 
