...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${periodwinscore}</td>
            <td class="hidden-480">${periodgamecount}</td>
            <td>${dailywinscore}</td>
            <td class="hidden-480">${paycontribution}</td>
            <td>${totalplayscore}</td>
            <td class="hidden-480">${totalwinscore}</td>
            <td>${totalshotcount}</td>
            <td>${dailyshotcount}</td>
            <td>${forcepool}</td>
            <td>${rewardpool}</td>
            <td>${money}</td>
            <td>${secondmoney}</td>
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="main-container-inner">
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>捕鱼游戏记录  <!--游戏选择：<label id="mycurrentgameid">全部（10000）</label>--></h5>
            ...
            <th>当前捕鱼总赢分</th>
             <th>当前总发射次数</th>
            <th class="hidden-480">当前每日发射次数</th>
            <th>当前强发库值</th>
            <th>当前奖励库值</th>
            <th>当前金豆数量</th>
            <th>当前钻石数量</th>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish1/get_exchange_data", packet, onsuccess, onerrors);
        }
