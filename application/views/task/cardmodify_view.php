										...
										<div class="widget-body">
													...
													<tr>
														...
														<td>
															<input type="text" id="bankcard_no" name="bankcard_no" placeholder=""
																class="col-xs-10 col-sm-2" value="<?php echo $info['bankcard_no'];?>"
														...
														<td>
															<input type="text" id="bank_branch" name="bank_branch" placeholder=""
																class="col-xs-10 col-sm-2" value="<?php echo $info['bank_branch'];?>"
																style="margin-left: 0px; height: 30px; width: 120px;" />
														</td>
													</tr>
													<tr>
														...
														<td>
															<input type="text" id="cardholder_name" name="cardholder_name" placeholder=""
																class="col-xs-10 col-sm-2" value="<?php echo $info['cardholder_name'];?>"
																style="margin-left: 0px; height: 30px; width: 120px;" />
														</td>
														<td>
														...
														<td>
															<input type="text" id="cardholder_mobile" name="cardholder_mobile" placeholder=""
																class="col-xs-10 col-sm-2" value="<?php echo $info['cardholder_mobile'];?>"
																style="margin-left: 0px; height: 30px; width: 120px;" />
														</td>
													</tr>
													<tr>
														...
														<td>
															<select id="customer_type" name="customer_type" class="form-control">
																<option value="01" <?php if($info['customer_type'] == '01'){ ?> selected="selected" <?php } ?> >个人</option>
																<option value="02" <?php if($info['customer_type'] == '02'){ ?> selected="selected" <?php } ?> >企业</option>
															</select>
														</td>
														<td>
														...
														<td>
															<select id="account_type" name="account_type" class="form-control">
																<option value="01" <?php if($info['account_type'] == '01'){ ?> selected="selected" <?php } ?> >借记卡</option>
																<option value="04" <?php if($info['account_type'] == '04'){ ?> selected="selected" <?php } ?> >企业对公账户</option>
															</select>
														</td>
														...
														<td style="display:none">
															<input type="text" id="pay_password" name="pay_password" placeholder=""
																class="col-xs-10 col-sm-2"  value="<?php echo $info['pay_password'];?>"
																style="margin-left: 0px; height: 30px; width: 120px;" />
														</td>
													</tr>
													<tr>
														...
														<td>
															<input type="text" id="headquarters_bank_id" name="headquarters_bank_id" placeholder=""
																class="col-xs-10 col-sm-2" value="<?php echo $info['headquarters_bank_id'];?>"
																style="margin-left: 0px; height: 30px; width: 120px;" />
														</td>
														<td>
														...
														<td>
															<input type="text" id="issue_bank_id" name="issue_bank_id" placeholder=""
																class="col-xs-10 col-sm-2" value="<?php echo $info['issue_bank_id'];?>"
																style="margin-left: 0px; height: 30px; width: 120px;" />
														</td>
													</tr>
													<tr>
														...
														<td colspan="3">
															<textarea class="form-control"  style="width:100%; margin-right: 10px;"
																id="describe" name="describe" rows="3" ><?php echo $info['describe'];?></textarea>
														</td>
													</tr>
												</table>
											</div>
											<div class="modal-body no-padding">
												...
												<div id="btn_ns_span" class="form-group">
													<button onclick="javascript:ajaxModifyCard()"
...
<script type="text/javascript">
	...
	function ajaxModifyCard()
	{
		var _url = "<?php echo site_url('task/cardmgr/ajaxModifyCard') . "?id=" . $info['id']; ?>";
		...
		var _data_obj = {
				...
				cardholder_mobile:_cardholder_mobile,
				describe:_describe,
				customer_type:_customer_type,
				account_type:_account_type,
				pay_password:_pay_password,
				headquarters_bank_id:_headquarters_bank_id,
				issue_bank_id:_issue_bank_id
				};
