...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td class="hidden-480">${beforesecondmoney}</td>
            
            <td>${aftersecondmoney}</td>
                <td>${rewarditemtype}</td> 
<td>${rewarditemnum}</td> 
<td>${beforeitemnum}</td> 
<td>${beforepaycontribution}</td> 
<td>${afterpaycontribution}</td> 
<td>${recordtime}</td>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>捕鱼大厅钻石抽奖查询</h5>
                                                ...
                                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                    <thead id="targethead">
                                                        <tr>
                                                            ...
                                                            <th class="hidden-480">抽奖前钻石数量</th>
                                                             <th>抽奖后钻石数量</th>
        ...
        function get_online_data() {
          ...
          // alert( gamename1[$("#form-field-select-3").val()]);
            ...
            function onsuccess(data) {
                ...
                {
                    datax["detail"][itemx]["rewarditemtype"]  =  tasknamenn[ parseInt( datax["detail"][itemx]["rewarditemtype"])];
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish12/get_zhanshi_data", packet, onsuccess, onerrors);
        }
