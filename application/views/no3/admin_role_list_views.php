								...
								<div class="col-xs-12 col-sm-12 widget-container-span">
									<div class="widget-box">
										<div class="widget-toolbox padding-8 clearfix">
                                            <a href="<?php echo site_url('no3/role/toAdd'); ?>" class="btn btn-success">添加角色</a>
                                        </div>
												...
												<table id="sample-table-2"
													...
													<?php foreach ($role_list as $v){ ?>
														<tr>
															...
															<td width="10%"><?php echo $v['role_name']; ?></td>
															<td><?php echo $v['admin_list']; ?></td>
															<td>
																<?php if($v['priv'] != 'all'){ ?>
																<a href="<?php echo site_url('no3/role/toEdit/'.$v['id']); ?>">修改</a>
																<?php } ?>
															</td>
														</tr>
													<?php } ?>
