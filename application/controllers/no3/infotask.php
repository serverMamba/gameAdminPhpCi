...
class Infotask extends MY_Controller {
	public function __construct() {
     ...
     public function get_task_data() {
      ...
      // }
       ...
       $res = $this->task_model->get_task_his($userid,$gameid,$modeid,$mystarttime,$myendtime,$account,$beginindex);
        ...
        if (file_exists($myfilename)) {
          ...
          // }
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"玩家任务记录"),
               "header1" => array("father"=>"客服管理","child"=>"玩家任务记录"),
               "header2" => array("father"=>"玩家任务记录","child"=>"显示玩家任务完成情况 "),
               "header3" => array("father"=>"玩家任务记录创建于2014年6月19日","child"=>" 游戏运营从2014年6月25日开始 (v1.0) "),
          );
           $this->load->view('no3/infotaskview',$data);
	}
