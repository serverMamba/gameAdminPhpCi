...
class Reportgame extends MY_Controller {
    ...
    public function get_reportgame_data() {
        ...
        $myfilename = "/var/www/html/smc/log/$key-$gameid-$time.log";
    ...
    public function index() {
       ...
       // }
         ...
         if ($usernamezz == "colin") {
             $gamecodehuang = array("teenpatti(257)" => 257,);
               $initdata = 257;
               $initdatastr = "印度扑克(257)";  
         }
        ...
        $data = array(
            ...
            "choose" => array("father" => "运营报表", "child" => "游戏数据报表"),
            "header1" => array("father" => "运营报表", "child" => "游戏数据报表"),
            "header2" => array("father" => "游戏数据报表", "child" => "指定游戏的主从报表"),
            "header3" => array("father" => "游戏数据报表后台创建于2014年5月23日，", "child" => " 游戏运营从2014年5月25日开始 (v1.0) "),
        );
        $this->load->view('no3/reportgameview', $data);
    }
