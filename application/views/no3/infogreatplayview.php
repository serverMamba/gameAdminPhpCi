...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${feesum}</td>
            <td>${feecount}</td>
            <td class="hidden-480">${feemin}</td>
            <td>${feemax}</td>
            <td>${dettime}</td>
            <td class="hidden-480">${timemin}</td>
            <td>${timemax}</td>
        </tr>
    </script>
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>状态选择：<label id="mystatusid">按照金额排序(1)</label></h5>
         ...
         <div class="widget-toolbar no-border pull-left" style="margin-top:-2px;">
                                            ...
                                            <div class="widget-toolbar no-border pull-left" style="margin-top:-2px;">
                                                ...
                                                <ul class="dropdown-menu dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                    <li>
                                                        <a href="javascript:changestatus('<?php echo 1 ?>','<?php echo "按照金额排序(1)" ?>')"><?php echo "按照金额排序(1)" ?></a>
                                                    </li>
                                                    
                                                    <li>
                                                        <a href="javascript:changestatus('<?php echo 2 ?>','<?php echo "按照次数排序(2)" ?>')"><?php echo "按照次数排序(2)" ?></a>
                                                    </li>
                                                    
                                                     <li>
                                                        <a href="javascript:changestatus('<?php echo 3 ?>','<?php echo "按照频率排序(3)" ?>')"><?php echo "按照频率排序(3)" ?></a>
                                                    </li>
                                            ...
                                            <div class="widget-main"  style ="padding:0;">
                                                ...
                                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                    <thead id="targethead">
                                                        <tr>
                                                            <th class="center">userID</th>
                                                            <th class="hidden-480">金额合计</th>
                                                            <th class="hidden-480">付费次数</th>
                                                             <th class="hidden-480">金额最小</th>
                                                             <th class="hidden-480">金额最大</th>
                                                             <th class="hidden-480">频度</th>
                                                            <th>起始时间</th>
                                                            <th class="hidden-480">终止时间</th>
                                                         </tr>
                                                    </thead>
...
/*
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/infogreatplay/get_greatplay_data", packet, onsuccess, onerrors);
        }
