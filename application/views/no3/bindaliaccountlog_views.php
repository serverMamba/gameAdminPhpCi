								...
								<div class="col-xs-12 col-sm-12 widget-container-span">
									<div class="widget-box">		
										<div class="widget-toolbox padding-8 clearfix">
											<form action="<?php echo site_url('no3/bindaliaccountlog/index');?>" style="float:left;" class="form-horizontal">
	                                            ...
	                                            <input value="<?php if($query['alipay_account']){echo $query['alipay_account']; }?>" type="text" placeholder="支付宝帐号" name="alipay_account"  class="col-xs-10 col-sm-2" style = "margin-left:5px;height:34px;width:80px;"/> 
												...
												<!-- <select name="bind">
	                                            	<option value="">绑定或解绑</option>
	                                            	<option value="1" <?php if("1"==="".$query['bind']){echo 'selected = \"selected\"';}?>>绑定</option>
	                                            	<option value="0" <?php if("0"==="".$query['bind']){echo 'selected = \"selected\"';}?>>解绑</option>
												</select>-->
											...
											<div class="widget-main" style="padding: 0;">
												<form action="" method="post" name="of" id="of">
													<table id="sample-table-2"
														...
														<tbody id="tbody">
														<?php if(!empty($bindaliaccountlog_list)){ foreach ($bindaliaccountlog_list as $v){ ?>
															<tr>
																<td><?php echo $v['userid']; ?></td>
																<td><?php echo $v['alipay_account']; ?></td>
																<td><?php if($v['bind'].''==='1'){ echo '绑定';}else{echo '解绑';}?></td>
																<td><?php echo $v['recordtime']; ?></td>
																<?php } ?>	
															</tr>
														<?php } ?>
														</tbody>
