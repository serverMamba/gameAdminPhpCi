...
$game_code = 1000;//平安游戏
$tabname_log = "smc_log_order_pingan";
...
foreach ( $channellist as $k => $v ) {
	...
	**/
	...
	VALUE ('$date_db','$order_total_num','$user_total_num','$pay_total_num','0','0','0','$k','$date1')";
	mysql_query ( $sql, $conn );
}
...
$sql = "INSERT INTO $tabname_log (date,order_total_num,user_total_num,pay_total_num,cash_money,choushui_money,cash_total_money,channel_id,date1)
VALUE ('$date_db','$order_total_num','$user_total_num','$pay_total_num','0','0','0','0','$date1')";
$result = mysql_query ( $sql, $conn );
if ($result) {
