...
<html lang="en">
    ...
    <script id="datamodel1" type="text/html" >
        <tr>
            ...
            <td>${emotionid}</td>
            <td class="hidden-480">${moneybefore}</td>
            <td>${moneyafter}</td>
    ...
    <script type="text/javascript">
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish4/get_exchange_data", packet, onsuccess, onerrors);
        }
