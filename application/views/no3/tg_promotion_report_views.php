								...
								<div class="col-xs-12 col-sm-12 widget-container-span">
									<div class="widget-box">
										<div class="widget-toolbox padding-8 clearfix">
											<form action="<?php echo site_url('no3/tgPromotion/report/'.$promotion_id);?>" style="float:left;" class="form-horizontal">
										...
										<div class="widget-body">
											<div class="widget-main" style="padding: 0;">
												<table id="sample-table-2"
													...
													<thead id="targethead">
														<?php foreach ($report['th_ary'] as $k=>$v){ ?>
														<th width="50"><?php echo $v; ?></th>
														<?php } ?>
													</thead>
													<tbody>
													<?php foreach ($report['td_ary'] as $k=>$v){ ?>
													<tr class="text-c">
