...
class Infogive2 extends MY_Controller {
	public function __construct() {
       ...
       $this->load->model('give2_model');
 
       $num = $this->input->get_post('num');
       
       $res = $this->give2_model->get_give_his($num);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"玩家输赢记录排行"),
               "header1" => array("father"=>"客服管理","child"=>"玩家输赢记录排行"),
               "header2" => array("father"=>"玩家输赢记录排行","child"=>"在线人数实时统计 "),
               "header3" => array("father"=>"玩家输赢记录排行后台创建于2014年10月18日","child"=>" 游戏运营从2014年10月20日开始 (v1.0) "),
          );
           $this->load->view('no3/infogive2view',$data);
	}
