...
class Reportsyjqr extends MY_Controller {
      ...
      public function analys() 
    {
        ...
        $this->load->model('syjqr_mid_model');
        $this->syjqr_mid_model->getrangeby($min,$max);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"运营报表","child"=>"输赢机器人统计"),
               "header1" => array("father"=>"运营报表","child"=>"输赢机器人统计"),
               "header2" => array("father"=>"输赢机器人统计","child"=>"用直方图的方式表达输赢机器人统计"),
               "header3" => array("father"=>"输赢机器人统计后台创建于2014年9月15日","child"=>" 游戏运营从2014年9月25日开始 (v1.0) "),
          );
           $this->load->view('no3/reportsyjqrview',$data);
	}
