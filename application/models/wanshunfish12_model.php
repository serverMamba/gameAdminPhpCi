 ...
 * 支付相关
 */
class wanshunfish12_model extends MY_Model {
    var $db = null;
   ...
   //  public function get_zhanshi_his($userid,$gameid,$mystarttime,$myendtime,$account,$beginindex) {
    ...
    public function get_zhanshi_his($userid,$mytasktime ,$account,$beginindex) {
        ...
        if($userid == 0){
            $tabsub = "CASINOFISHINGLOBBYPLAYLOTTERYRECORD".$myyear1.$mymonth1.$myday1;
        }else{
            $tabsub = "CASINOFISHINGLOBBYPLAYLOTTERYRECORD".$myyear1.$mymonth1.$myday1." where userid = $userid ";
        }
