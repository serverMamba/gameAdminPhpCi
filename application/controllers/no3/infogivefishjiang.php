...
class Infogivefishjiang extends MY_Controller {
	public function __construct() {
     ...
     public function get_givefishjiang_data() {
       $this->load->model('givefishjiang_model');
       ...
       $res = $this->givefishjiang_model->get_givefishjiang_his($userid,$gameid,$mystarttime,$myendtime,$beginindex);
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"客服管理","child"=>"幸运抽奖记录"),
               "header1" => array("father"=>"客服管理","child"=>"幸运抽奖记录"),
               "header2" => array("father"=>"幸运抽奖记录","child"=>"幸运抽奖记录 "),
               "header3" => array("father"=>"幸运抽奖记录后台创建于2016年3月24日","child"=>" 游戏运营从2016年3月20日开始 (v1.0) "),
          );
           $this->load->view('no3/infogivefishjiangview',$data);
	}
