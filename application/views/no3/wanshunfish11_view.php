                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-blue2">
                                            <h5><i class="icon-arrow-left"></i>一网打尽翻翻乐查询</h5>
        ...
        function get_online_data() {
          ...
          // alert( gamename1[$("#form-field-select-3").val()]);
            ...
            function onsuccess(data) {
                ...
                {
                    datax["detail"][itemx]["result"]  =  tasknamenn[ parseInt( datax["detail"][itemx]["result"])];
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/wanshunfish11/get_zhanshi_data", packet, onsuccess, onerrors);
        }
