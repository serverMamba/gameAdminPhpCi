...
class Wanshun5_model extends MY_Model {
    ...
    public function get_exchange_his($mydate){
        $CI = &get_instance();
        $db = $CI->load->database('globalinfo', true);

        $where = "where statistics_date  = '$mydate'   order by paycontribution desc"; 
       
        $sql =  "select * from  CASINOGLOBALINFO.CASINOTOPPAYCONTRIBUTIONUSER $where  ";
