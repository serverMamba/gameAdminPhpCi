...
class Reportanaly extends MY_Controller {
	...
	public function index() {
        ...
        if (file_exists($myfilename)) {
           ...
           $data =array(
               ...
               "choose" => array("father"=>"运营报表","child"=>"运营渠道分析"),
               "header1" => array("father"=>"运营报表","child"=>"运营渠道分析"),
               "header2" => array("father"=>"运营渠道分析","child"=>"分析渠道运营数据明细 "),
               "header3" => array("father"=>"运营渠道分析后台创建于2014年6月13日","child"=>" 游戏运营从2014年6月25日开始 (v1.0) "),
          );
           $this->load->view('no3/reportanalyview',$data);
	}
