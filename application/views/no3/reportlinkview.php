                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        <div class="widget-header header-color-pink">
                                            <h5><i class="icon-arrow-left"></i>游戏历史曲线,当前游戏：<label id="mycurrentgameid"><?php echo $initdatastr ?></label></h5>
       ...
       for (var xx = 0; xx < max; xx++) {
        ...
        function getnumber(str){
           var strlist = str.split(":");
            var num = parseInt(strlist[0])*6;
                num = num + parseInt(parseInt(strlist[1])  /10);
           return num;
          }
        ...
        function get_online_data() {
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/reportlink/get_link_data", packet, onsuccess, onerrors);
        }
