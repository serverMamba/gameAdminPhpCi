                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-span">
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-toolbox padding-8 clearfix">
                                            ...
                                            <button onclick="javascript:get_online_data1()" class="btn btn-xs btn-success " style="margin-top:3px;">
                                                <span class="bigger-110">金豆查询</span>

                                                <i class="icon-search icon-on-right"></i>
                                            </button>
                                            
                                            <button onclick="javascript:get_online_data2()" class="btn btn-xs btn-success " style="margin-top:3px;">
                                                <span class="bigger-110">保险箱查询</span>

                                                <i class="icon-search icon-on-right"></i>
                                            </button>
                                            
                                               <button onclick="javascript:get_online_data3()" class="btn btn-xs btn-success " style="margin-top:3px;">
                                                <span class="bigger-110">总数查询</span>
        ...
        function get_online_data1() {
            ...
            function onsuccess(data) {
                 ...
                 for (var itemx in itemtoday)
                {
                    ...
                    var xx = getnumber(tm);
                    var ct = parseInt(itemtoday[itemx]["sumchips"]);
                 ...
                 for (var itemx in itemtoday)
                {
                    var tm = itemtoday[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemtoday[itemx]["sumcofferchips"]);
                 ...
                 for (var itemx in itemtoday)
                {
                    var tm = itemtoday[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemtoday[itemx]["sumcofferchips"])+parseInt(itemtoday[itemx]["sumchips"]);
                ...
                for (var itemx in itemyest)
                {
                    ...
                    var xx = getnumber(tm);
                    var ct = parseInt(itemyest[itemx]["sumchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                 ...
                 for (var itemx in itemyest)
                {
                    var tm = itemyest[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemyest[itemx]["sumcofferchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                 ...
                 for (var itemx in itemyest)
                {
                    var tm = itemyest[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemyest[itemx]["sumcofferchips"])+parseInt(itemyest[itemx]["sumchips"]);;
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                ...
                for (var itemx in itemaweek)
                {
                    ...
                    var xx = getnumber(tm);
                    var ct = parseInt(itemaweek[itemx]["sumchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                 ...
                 for (var itemx in itemaweek)
                {
                    var tm = itemaweek[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemaweek[itemx]["sumcofferchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                ...
                for (var itemx in itemaweek)
                {
                    var tm = itemaweek[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemaweek[itemx]["sumcofferchips"])+parseInt(itemaweek[itemx]["sumchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                 ...
                 for (var itemx in itemamon)
                {
                    ...
                    var xx = getnumber(tm);
                    var ct = parseInt(itemamon[itemx]["sumchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                ...
                for (var itemx in itemamon)
                {
                    var tm = itemamon[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemamon[itemx]["sumcofferchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                 ...
                 for (var itemx in itemamon)
                {
                    var tm = itemamon[itemx]["tm"];
                    var xx = getnumber(tm);
                    var ct = parseInt(itemamon[itemx]["sumcofferchips"])+ parseInt(itemamon[itemx]["sumchips"]);
                    if (maxdata < ct)
                    {
                        maxdata = ct;
                    }
                ...
                $.plot("#sales-charts", [
                    {label: "金豆上月的今天", data: d4},
                    {label: "金豆上周的今天", data: d2},
                    {label: "金豆昨天", data: d1},
                    {label: "金豆今天", data: d3}
            ...
            jQuery.comm.sendmessage(window.location.protocol + "//" + window.location.host + "/no3/reportcoffee/get_his_data", packet, onsuccess, onerrors);
        }
        
        
            function get_online_data2() {
            var packet = {
                action: 'get_online_data',
                gameid: m_gameid,
                mytime: $("#id-date-picker-1").val()
            ...
            function onsuccess(data) {
                ...
                $.plot("#sales-charts", [
                    ...
                    {label: "保险箱上月的今天", data: e4},
                    {label: "保险箱上周的今天", data: e2},
                    {label: "保险箱昨天", data: e1},
                    {label: "保险箱今天", data: e3}
            ...
            function onsuccess(data) {
                ...
                var sales_charts = $('#sales-charts').css({'width': '100%', 'height': '420px'});
                $.plot("#sales-charts", [
                    {label: "总数上月的今天", data: u4},
                    {label: "总数上周的今天", data: u2},
                    {label: "总数昨天", data: u1},
                    {label: "总数今天", data: u3}
