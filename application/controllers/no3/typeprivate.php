   ...
   public function get_private_data() {
    ...
    public function index() {
        ...
        $data = array(
            ...
            "choose" => array("father" => "运维管理", "child" => "后台权限设定"),
            "header1" => array("father" => "运维管理", "child" => "后台权限设定"),
            "header2" => array("father" => "运维管理", "child" => "编辑后台人员的权限。 "),
            "header3" => array("father" => "后台权限设定创建于2014年7月23日", "child" => " 后台权限设定从2014年7月25日开始 (v1.0) "),
        );
        $this->load->view('no3/typeprivateview', $data);
    }
